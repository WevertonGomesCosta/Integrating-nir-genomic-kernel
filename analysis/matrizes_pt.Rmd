...
Esta última seção também é escrita de forma direta: são listados os objetos de interesse, a preservação em disco é documentada, os objetos temporários são removidos e as matrizes preservadas podem ser recarregadas.
