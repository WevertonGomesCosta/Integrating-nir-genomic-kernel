...
required_files <- c(
  ...
  "Pheno.rds", "Pedigree.rds", "kernel_inventory_linear.csv",
  "kernel_inventory_nonlinear.csv"
)
...
```{r shared-genotypes-all-envs-display, results='asis'}
...
```{r kernel-diagnostic-figure-square, eval=FALSE, fig.width=8, fig.height=8}
...
```{r kernel-diagnostic-figure-display, echo=FALSE, results='asis'}
fig_files <- c(
