...
As figuras finais resumem a capacidade preditiva para o catálogo completo de modelos em `CV1/CV2` e `CV0/CV00`. Para evitar ambiguidades na interpretação e em futuras revisões, os gráficos passam a exibir a composição completa dos efeitos de cada modelo, e não apenas rótulos curtos.
