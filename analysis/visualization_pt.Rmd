...
Na versão em português, as tabelas leves já produzidas pelo arquivo em inglês são carregadas silenciosamente para evitar repetir a leitura e a consolidação completas dos resultados de predição.
...
Este chunk documenta a leitura dos arquivos de CV1 e CV2, incluindo a interpretação dos nomes, a recuperação do fold a partir de `.id` e a reconstrução dos metadados usados nos resumos.
