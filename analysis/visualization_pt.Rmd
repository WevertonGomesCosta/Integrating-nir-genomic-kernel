...
## 5. Descoberta dos arquivos de predição

Antes de resumir separadamente cada esquema de validação, primeiro localizamos todos os arquivos de predição produzidos pelos scripts de execução e os separamos em grupos baseados em genótipo e leave-one-environment-out.

### 5.1 Localizar todos os arquivos de predição
...
## 6. Fluxo de CV1 e CV2

Esta seção mantém juntas todas as etapas dos esquemas baseados em genótipo: leitura dos arquivos, resumo dos resultados, geração das tabelas de comparação e construção da figura final.

### 6.1 Ler os arquivos de CV1 e CV2
...
### 6.3 Construir os objetos de comparação para CV1 e CV2

```{r comparison-cv12, eval=FALSE}
...
### 6.4 Construir os objetos compactos de exibição e Top-3 para CV1 e CV2

```{r display-cv12, eval=FALSE}
...
### 6.5 Exibir a tabela Top-3 de CV1 e CV2
...
### 6.6 Exibir a tabela do efeito de W em CV1 e CV2
...
### 6.7 Exibir a tabela de comparação entre famílias de kernel em CV1 e CV2
...
### 6.8 Construir a figura final de CV1 e CV2
...
## 7. Fluxo de CV0 e CV00

Esta seção mantém juntas todas as etapas dos esquemas leave-one-environment-out: leitura dos arquivos, resumo dos resultados, geração das tabelas de comparação e construção da figura final.

### 7.1 Ler os arquivos de CV0 e CV00
...
### 7.3 Construir os objetos de comparação para CV0 e CV00

```{r comparison-cvloo, eval=FALSE}
...
### 7.4 Construir os objetos compactos de exibição e Top-3 para CV0 e CV00

```{r display-cvloo, eval=FALSE}
...
### 7.5 Exibir a tabela Top-3 de CV0 e CV00
...
### 7.6 Exibir a tabela do efeito de W em CV0 e CV00
...
### 7.7 Exibir a tabela de comparação entre famílias de kernel em CV0 e CV00
...
### 7.8 Construir a figura final de CV0 e CV00
