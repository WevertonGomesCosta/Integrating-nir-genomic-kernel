...
dir.create("output/componentes_variancia", recursive = TRUE, showWarnings = FALSE)
...
results_list <- foreach(i = 1:nrow(combos),
  ...
  out_dir <- file.path("output/componentes_variancia", paste0("rep_", rep_num), paste0("M", Model))
