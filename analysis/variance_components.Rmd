...
knitr::kable(input_file_index, caption = "Required matrix and kernel objects used by this step.")
```
...
The saved outputs from the estimation stage are consolidated below into a single structure that can be processed more easily later.
...
This section loads the consolidated variance-component results so that they can be summarized and visualized without repeating the expensive estimation.
