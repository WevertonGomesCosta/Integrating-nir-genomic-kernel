...
if (length(missing_files) > 0) {
  stop(
    ...
    ". Check whether the required matrices are available before rendering this document."
  )
}
```
...
The document now loads the consolidated variance-component results so that it can summarize and visualize them without repeating the expensive estimation.
...
if (!file.exists(raw_file)) {
  stop(
    ...
    "Make sure the consolidated object exists or keep the previously saved _metrics.rds files in output/variance_components/."
  )
}
