...
output_examples <- bind_rows(
  tibble::tibble(
    ...
    Meaning = c(
      "Prediction accuracy for CV1, trait GY, model M1 (EtaName Eta1), repetition 1, fold 1.",
      "Prediction accuracy for CV2, trait KW, model M18 (EtaName Eta18), repetition 10, fold 5."
    )
  ),
  tibble::tibble(
    ...
    Meaning = c(
      "Prediction accuracy for CV0, trait GY, held-out environment CS11_WS, model M1 (EtaName Eta1), repetition 1, fold 1.",
      "Prediction accuracy for CV00, trait KW, held-out environment CS12_WW, model M18 (EtaName Eta18), repetition 10, fold 2."
    )
  )
)
