...
Before we summarize each validation scheme separately, we first locate all prediction files produced by the execution scripts and split them into genotype-based and leave-one-environment-out groups.

### 5.1 Locate all prediction files

```{r locate-files}
all_result_rel_paths <- list.files(results_dir, pattern = "\\.csv$", full.names = FALSE, recursive = TRUE)
all_result_rel_paths <- gsub("\\", "/", all_result_rel_paths, fixed = TRUE)
...
## 6. CV1 and CV2 workflow

This section keeps every step for the genotype-based schemes together: reading files, summarizing results, generating comparison tables, and drawing the final figure.

### 6.1 Read CV1 and CV2 files
...
### 6.3 Build comparison objects for CV1 and CV2
...
### 6.4 Build compact display and Top-3 objects for CV1 and CV2
...
### 6.5 Show the Top-3 table for CV1 and CV2
...
### 6.6 Show the W-effect table for CV1 and CV2
...
### 6.7 Show the kernel-family comparison table for CV1 and CV2
...
### 6.8 Draw the final figure for CV1 and CV2
...
## 7. CV0 and CV00 workflow

This section keeps every step for the leave-one-environment-out schemes together: reading files, summarizing results, generating comparison tables, and drawing the final figure.

### 7.1 Read CV0 and CV00 files
...
### 7.3 Build comparison objects for CV0 and CV00
...
### 7.4 Build compact display and Top-3 objects for CV0 and CV00
...
### 7.5 Show the Top-3 table for CV0 and CV00
...
### 7.6 Show the W-effect table for CV0 and CV00
...
### 7.7 Show the kernel-family comparison table for CV0 and CV00
...
### 7.8 Draw the final figure for CV0 and CV00
