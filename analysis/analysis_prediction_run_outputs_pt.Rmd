...
A etapa completa de ajuste é preservada aqui para manter o fluxo íntegro. Quando a etapa de predição precisar ser rerodada, o código mostrado abaixo é a versão operacional usada pelo pipeline.
...
foreach(i = seq_len(nrow(combos)),
  ...
  for (fold_num in seq_len(num_fold)) {
    ...
    for (env_idx in seq_along(envs_leaveout)) {
      ...
      save_prefix_env <- file.path(run_dir, paste0("CV0_", TRAIT, "_", env_name, "_Eta", MODEL, "_", rep_label, "_", fold_label, "_"))
...
output_examples <- bind_rows(
  ...
  tibble::tibble(
    ...
    bglr_example = c(
      "bglr_runs/CV0/CS11_WS/GY/rep01/fold01/Eta1/CV0_GY_CS11_WS_Eta1_rep01_fold01_GW_RKHS_varU.dat",
