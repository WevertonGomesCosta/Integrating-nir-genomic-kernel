...
This last section is also written in a direct way: we list which objects will be saved, write them to disk, remove the remaining temporary objects, and then reload the saved matrices.
