...
The helper functions below are used to optimize and generate the nonlinear genomic and phenomic Gaussian kernels.
...
The functions below define the arc-cosine kernels used to compute the additive nonlinear structures.
