...
if (!file.exists(annual_ec_file)) {
  stop("The file 'output/climate_results/environmental_covariates.csv' was not found. Check that the climate-derived covariate files are available before rendering this document.")
}

if (!file.exists(expanded_ec_file)) {
  stop("The file 'output/climate_results/environmental_covariates_expanded.csv' was not found. Check that the climate-derived covariate files are available before rendering this document.")
}
