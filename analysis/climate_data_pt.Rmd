...
**Próxima etapa**
- `matrizes.Rmd` usa as saídas derivadas do clima geradas aqui para alinhar a informação ambiental com a estrutura observacional e construir o kernel climático (`W`).
