...
if (!file.exists(raw_climate_path)) {
  stop("Arquivo não encontrado: 'output/climate_results/texas_climate_data_raw.csv'. Verifique se a base bruta está disponível em 'output/climate_results/'.")
}
...
if (!file.exists(weather_covariates_path) || !file.exists(ecs_expanded_path)) {
  stop("Arquivos finais de clima não encontrados em 'output/climate_results/'. Verifique se as covariáveis climáticas estão disponíveis em 'output/climate_results/'.")
}
