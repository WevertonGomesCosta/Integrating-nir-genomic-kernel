...
write.csv(df, "output/Pred.ability/Pred.ability.CV0.CV00.csv")  # Salva consolidação
```
...
write.csv(df, "output/Pred.ability/Pred.ability.CV1.CV2.csv")  # Salva consolidação
```
